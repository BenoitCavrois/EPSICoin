...
(1, 'Cavrois', 'Benoit', 'B3', 'etudiant1', 'password', 1),
(2, 'Duisant', 'Cristofer', 'B3', 'etudiant2', 'password', 1),
(3, 'Lotigier', 'Louis', 'B3', 'etudiant3', 'password', 1),
(4, 'Bouslah', 'Nadir', 'B3', 'etudiant4', 'password', 1),
(5, 'Clerbout', 'Jérôme', 'B3', 'etudiant5', 'password', 1),
(6, 'Desoomer', 'Pierre-Henri', 'B3', 'etudiant6', 'password', 2),
(7, 'Desmis', 'Gabin', 'B3', 'etudiant7', 'password', 2),
(8, 'Coupé', 'Paul', 'B3', 'etudiant8', 'password', 2),
(9, 'Guittard', 'Jonathan', 'B3', 'etudiant9', 'password', 2),
(10, 'Minne', 'Pierre-Yves', 'B3', 'etudiant10', 'password', 2),
(11, 'Taibi', 'Hasnae', 'B3', 'etudiant11', 'password', 3),
(12, 'Pakhomoff', 'Aliocha', 'B3', 'etudiant12', 'password', 3),
(13, 'Guazzoni', 'Damien', 'B3', 'etudiant13', 'password', 3),
(14, 'Maton', 'Maxence', 'B3', 'etudiant14', 'password', 3);
...
INSERT INTO `projet` (`Id`, `NomProjet`, `Id_Responsable_pedagogique`, `jetonA`, `jetonB`, `jetonC`) VALUES
(1, 'Workshop', 1, NULL, 0, NULL);
